...
TARGET_FIELDS = [
    ...
    StructField("rapid7_site_description", StringType(), True),
    StructField("rapid7_site_importance", StringType(), True),
    StructField("rapid7_site_last_scan_time", StringType(), True),
    StructField("rapid7_site_risk_score", DoubleType(), True),
    StructField("rapid7_site_scan_engine", LongType(), True),
    StructField("rapid7_site_scan_template", StringType(), True),
    StructField("rapid7_site_type", StringType(), True),
    StructField("rapid7_site_assets", LongType(), True),
    StructField("rapid7_site_vuln_total", LongType(), True),
    StructField("rapid7_site_vuln_critical", LongType(), True),
    StructField("rapid7_site_vuln_severe", LongType(), True),
    StructField("rapid7_site_vuln_moderate", LongType(), True),
